...
<head>
    ...
    <link rel="shortcut icon"
        ...
        type="image/png" />
        <link rel="stylesheet" href="{{ asset('asset-template/extensions/choices.js/public/assets/styles/choices.css') }}">
...
<body>
    ...
    <script src="{{ asset('asset-template/extensions/choices.js/public/assets/scripts/choices.js') }}"></script>
    <script src="{{ asset('asset-template/static/js/pages/form-element-select.js') }}"></script>
    <!-- Need: Apexcharts -->
