        ...
        <div class="card">
            <div class="card-header mb-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="ml-auto">
                        <a href="/books/create" class="btn btn-primary add-button"><span>Add Data</span></a>
                        {{-- <a href="/books/index" class="btn btn-warning back-button"><span>Back</span></a> --}}
                    </div>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group mr-2" role="group" aria-label="Action Button">
                                            <a href="/books/detail/{{ $book->id}}" class="btn btn-primary"><i class="bi bi-eye-fill"></i></a>
                                            <a href="/books/edit/{{ $book->id}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
