            ...
            <div class="card-body">
                <form action="/users/edit/{{ $user->id }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone',$user->phone) }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="address" rows="2" name="address">{{ old('phone',$user->address) }}</textarea>
