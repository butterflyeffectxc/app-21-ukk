                            ...
                            <div class="table-responsive">
                                <table class="table" id="table2">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <div class="btn-group mr-2" role="group" aria-label="Action Button">
                                                <a href="/operators/detail/{{ $operator->id }}" class="btn btn-primary"><i class="bi bi-eye-fill"></i></a>
                                                <a href="/operators/edit/{{ $operator->id }}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
